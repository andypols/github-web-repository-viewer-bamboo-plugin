...
Links GitHub repository changes back to the GitHub page containing the commit/diff.  Works with Bamboo's built-in git repository.

Works with Bamboo version 3.0 or greater.
* Tested on Ubuntu and OSX. Should work on Windows!

Tested on Bamboo version 3.0.  More information on the "project wiki":http://wiki.github.com/andypols/github-web-repository-viewer-bamboo-plugin.
